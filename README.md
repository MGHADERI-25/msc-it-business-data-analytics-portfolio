...
**Description:**  
Design and implementation of a normalized relational database for managing cybersecurity incident reports, including employees, threat types, response actions, and training records. The project emphasizes database design, referential integrity, manufactured data, and analytical SQL queries.

**Key Skills & Tools:**  
SQL · SQLite · Database Design · Normalization · ER Diagrams · DBeaver · Data Integrity
...
Mohammadali Ghaderi, MSc IT for Business Data Analytics  
International Business School (IBS), Budapest
